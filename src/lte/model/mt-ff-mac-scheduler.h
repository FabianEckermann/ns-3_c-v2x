...
private:
  ...
  */
  std::map <LteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters> m_rlcBufferReq;
  ...
  */
  ...
  std::map <LteFlowId_t,struct NistLogicalChannelConfigListElement_s> m_ueLogicalChannelsConfigList;
