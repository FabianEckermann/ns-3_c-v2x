...
class RrSlSchedulerMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  RrSlSchedulerMemberCschedSapProvider (RrSlFfMacScheduler* scheduler);
...
private:
  ...
  RrSlFfMacScheduler* m_scheduler;
};
...
RrSlSchedulerMemberCschedSapProvider::RrSlSchedulerMemberCschedSapProvider (RrSlFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
RrSlSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
RrSlSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedPoolConfigReq (const struct CschedPoolConfigReqParameters& params)
{
  m_scheduler->DoCschedPoolConfigReq (params);
}
  
void
RrSlSchedulerMemberCschedSapProvider::CschedPoolReleaseReq (const struct CschedPoolReleaseReqParameters& params)
{
...
class RrSlSchedulerMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  RrSlSchedulerMemberSchedSapProvider (RrSlFfMacScheduler* scheduler);
...
RrSlSchedulerMemberSchedSapProvider::RrSlSchedulerMemberSchedSapProvider (RrSlFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
RrSlFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RrSlFfMacScheduler")
    ...
    .AddAttribute ("SlGrantMcs",
                   ...
                   UintegerValue (0),
                   MakeUintegerAccessor (&RrSlFfMacScheduler::m_slGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
...
RrSlFfMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  ...
  //std::cout<<" ENTER RrSlFfMacScheduler::DoSchedDlTriggerReq"<<std::endl;
 ...
 //std::cout<<" next rnti dl = "<<(int)m_nextRntiDl<<" next lcid dl = "<<(int)m_nextLcidDl<<std::endl;
  ...
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator itBufferAux;  //added
  ...
  do
    ...
    //case mcs = 0 : 
     ...
     int nLayer1 = TransmissionModesLayers::TxMode2LayerNum ((*itTxMode).second);
     ...
     //added 
     std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator itBuffer;
      if (( m_nextRntiDl == 0) && (m_nextLcidDl==0 ) )
     ...
     do 
               ...
               if ( ((*itBuffer).m_rnti ==  (*it).m_rnti) && ( (*itBuffer).m_rlcTransmissionQueueSize > 0 ) ) 
                {
                   ...
                   std::vector <LteFlowId_t>::iterator itSFlows;
                   ...
                   if (findF==false)
                    { 
                      ...
                      std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator itTemp;
      ...
      std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator itConstructDci;
...
RrSlFfMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
  ...
  RefreshUlCqiMaps ();
  //std::cout<<" ENTER RrSlFfMacScheduler::DoSchedUlTriggerReq "<<std::endl;
  // Generate RBs map
...
void
RrSlFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
