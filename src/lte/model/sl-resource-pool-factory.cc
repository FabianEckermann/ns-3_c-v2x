...
NS_LOG_COMPONENT_DEFINE ("SlResourcePoolFactory");

SlResourcePoolFactory::SlResourcePoolFactory () :
  m_scCpLen("NORMAL"),
  m_period("sf40"),
  m_scPrbNum(22),
  m_scPrbStart(0),
...
SlResourcePoolFactory::CreatePool ()
{
  // Control
...
// Control
void
SlResourcePoolFactory::SetControlCpLen (std::string cpLen)
{
...
void
SlResourcePoolFactory::SetControlPeriod (std::string period)
{
...
void
SlResourcePoolFactory::SetControlPrbNum (int prbNum)
{
...
void
SlResourcePoolFactory::SetControlPrbStart (int prbStart)
{
...
void
SlResourcePoolFactory::SetControlPrbEnd (int prbEnd)
{
...
void
SlResourcePoolFactory::SetControlOffset (int offset)
{
...
void
SlResourcePoolFactory::SetControlBitmap (uint64_t value)
{
...
// Data
void
SlResourcePoolFactory::SetDataCpLen (std::string cpLen)
{
  NS_LOG_FUNCTION (this << cpLen);
  m_dataCpLen = cpLen;
}
...
void
SlResourcePoolFactory::SetDataHoppingParameters (int hoppingParameters)
{
...
void
SlResourcePoolFactory::SetDataHoppingSubbands (std::string subbands)
{
...
void
SlResourcePoolFactory::SetDataHoppingOffset (int rbOffset)
{
...
// UE Selected Parameters
void
SlResourcePoolFactory::SetHaveUeSelectedResourceConfig (bool ueSelected)
{
...
void
SlResourcePoolFactory::SetHaveTrptSubset (bool haveTrptSubset)
{
...
void
SlResourcePoolFactory::SetTrptSubset (int value)
{
  NS_LOG_FUNCTION (this << value);
...
void
SlResourcePoolFactory::SetDataPrbNum (int prbNum)
{
  NS_LOG_FUNCTION (this << prbNum);
  m_dataPrbNum = prbNum;
}
...
void
SlResourcePoolFactory::SetDataPrbStart (int prbStart)
{
  NS_LOG_FUNCTION (this << prbStart);
...
void
SlResourcePoolFactory::SetDataPrbEnd (int prbEnd)
{
  NS_LOG_FUNCTION (this << prbEnd);
  m_dataPrbEnd = prbEnd;
}
...
void
SlResourcePoolFactory::SetDataOffset (int offset)
{
  NS_LOG_FUNCTION (this << offset);
  m_dataOffset = offset;
}
...
void
SlResourcePoolFactory::SetDataBitmap (int value)
{
  NS_LOG_FUNCTION (this << value);
...
// Tx Parameters
void
SlResourcePoolFactory::SetHaveTxParameters (bool txParam)
{
...
void
SlResourcePoolFactory::SetControlTxAlpha (std::string alpha)
{
...
void
SlResourcePoolFactory::SetControlTxP0 (int p0)
{
...
void
SlResourcePoolFactory::SetDataTxAlpha (std::string alpha)
{
  NS_LOG_FUNCTION (this << alpha);
  m_dataAlpha = alpha;
}
...
void
SlResourcePoolFactory::SetDataTxP0 (int p0)
{
  NS_LOG_FUNCTION (this << p0);
  m_dataP0 = p0;
}
