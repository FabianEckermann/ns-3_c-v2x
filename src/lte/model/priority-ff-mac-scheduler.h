...
#ifndef PRIORITY_FF_MAC_SCHEDULER_H
#define PRIORITY_FF_MAC_SCHEDULER_H
...
class PriorityFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  PriorityFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~PriorityFfMacScheduler ();
...
private:
  ...
  */
  std::map <uint16_t, PrioritysFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, PrioritysFlowPerf_t> m_flowStatsUl;
...
#endif /* _PRIORITY_FF_MAC_SCHEDULER_H */
