...
NS_LOG_COMPONENT_DEFINE ("SlV2xPreconfigPoolFactory");

SlV2xPreconfigPoolFactory::SlV2xPreconfigPoolFactory ()
{
  m_ueSelected = true;
...
LteRrcSap::SlV2xPreconfigCommPool
SlV2xPreconfigPoolFactory::CreatePool ()
{
  ...
  if (m_adjacencyPscchPssch == true) {
    switch (m_sizeSubchannel)
    {
      ...
      case 75:
      case 100:
        m_pool.sizeSubchannel = LteRrcSap::SizeSubchannelFromInt (m_sizeSubchannel);
        break;
      case 4:
      case 8:
      case 9:
  ...
  */
  ...
  m_pool.numSubchannel = LteRrcSap::NumSubchannelFromInt (m_numSubchannel);
  /*
  ...
  */
  ...
  m_pool.dataTxParameters.alpha = LteRrcSap::AlphaFromDouble (m_dataAlpha);
  /*
